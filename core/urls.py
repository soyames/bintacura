...
from . import views
from .system_views import GetConsultationFeeView, GetParticipantServicesView, ConvertCurrencyView, GetPlatformFeeView
...
urlpatterns = [
    ...
    path("settings/platform-fee/", GetPlatformFeeView.as_view(), name="platform-fee"),
