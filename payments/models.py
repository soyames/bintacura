...
class PaymentReceipt(SyncMixin):  # Generates and stores payment receipts for transactions
    ...
    issued_to_name = models.CharField(max_length=255, default='', null=False, blank=True)
    issued_to_address = models.TextField(default='', null=False, blank=True)
    issued_to_city = models.CharField(max_length=100, default='', null=False, blank=True)
    issued_to_country = models.CharField(max_length=100, default='', null=False, blank=True)
    amount = models.DecimalField(max_digits=12, decimal_places=2, default=0.00, null=False)
    ...
    currency = models.CharField(max_length=3, default='XOF')
    payment_method = models.CharField(max_length=50, default='cash', null=False, blank=True)
    payment_gateway = models.CharField(max_length=50, default='', null=False, blank=True)
    transaction_reference = models.CharField(max_length=200, default='', null=False, blank=True)
    gateway_transaction_id = models.CharField(max_length=200, default='', null=False, blank=True)
    pdf_url = models.CharField(max_length=500, default='', null=False, blank=True)
